...
use {jemalloc_sys as jemallocffi, jemallocator::Jemalloc};
#[cfg(feature = "jemalloc-sys")]
#[global_allocator]
static GLOBAL: Jemalloc = Jemalloc;

#[cfg(feature = "mimalloc")]
use {libmimalloc_sys as mimallocffi, mimalloc::MiMalloc};
#[cfg(feature = "mimalloc")]
#[global_allocator]
...
extern "C" fn raw_mimalloc_malloc(_ctx: *mut c_void, size: size_t) -> *mut c_void {
    ...
    // Returns a unique pointer if called with `size` 0
    let padding = _ctx as *const _ as usize;
    unsafe { libmimalloc_sys::mi_malloc(size + padding) as *mut _ }
}
...
extern "C" fn raw_mimalloc_calloc(_ctx: *mut c_void, nelem: size_t, elsize: size_t) -> *mut c_void {
    ...
    let padding = _ctx as *const _ as usize;
    unsafe { libmimalloc_sys::mi_calloc(nelem, size + padding) as *mut _ }
}
...
extern "C" fn raw_mimalloc_realloc(
    ...
    // uninitialized
    let padding = _ctx as *const _ as usize;
    unsafe { libmimalloc_sys::mi_realloc(ptr as *mut _, new_size + padding) as *mut _ }
}
