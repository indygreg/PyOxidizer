...
pub mod tests {
	...
	pub static EXTENSION_MODULE_SHARED_LIBRARY_ONLY: Lazy<PythonExtensionModule> = Lazy::new(|| {
	...
	pub static EXTENSION_MODULE_OBJECT_FILES_ONLY: Lazy<PythonExtensionModule> = Lazy::new(|| {
		PythonExtensionModule {
	...
	pub static EXTENSION_MODULE_SHARED_LIBRARY_AND_OBJECT_FILES: Lazy<PythonExtensionModule> = Lazy::new(|| {
		PythonExtensionModule {
