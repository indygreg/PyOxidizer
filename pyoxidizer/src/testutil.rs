...
pub static DEFAULT_DISTRIBUTION_TEMP_DIR: Lazy<tempfile::TempDir> = Lazy::new(|| {tempfile::Builder::new()
	.prefix("pyoxidizer-test")
	.tempdir()
	.expect("unable to create temp directory")
});
pub static DISTRIBUTION_CACHE: Lazy<Arc<DistributionCache>> = Lazy::new(|| {Arc::new(DistributionCache::new(
